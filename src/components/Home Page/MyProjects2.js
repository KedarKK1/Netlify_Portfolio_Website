                ...
                <Col>
                    ...
                    <Timeline mode="alternate">
                        <Timeline.Item color="green">
                            ...
                            <p style={{ color:textColor }}><h6 style={{ color:textColor }}><a href="https://github.com/KedarKK1/Netlify_Portfolio_Website/">Github link</a></h6><h6 style={{ color:textColor }}><a href="https://kedarkoshti.netlify.app/">Link</a></h6></p>
                        </Timeline.Item>
                        <Timeline.Item color="red">
                            ...
                            <p style={{ color:textColor }}><h6 style={{ color:textColor }}><a href="https://github.com/KedarKK1/Advanced-To-do-list-app-using-AntD.git/">Link</a></h6></p>
                        </Timeline.Item>
                        <Timeline.Item color="green">
                            ...
                            <p style={{ color:textColor }}><h6 style={{ color:textColor }}><a href="https://github.com/KedarKK1/PBL_2_PanditMitra_22-02-2022/tree/final_webbsite/">Link</a></h6></p>
                        </Timeline.Item>
                        <Timeline.Item color="red">
                            ...
                            <p style={{ color:textColor }}><h6 style={{ color:textColor }}><a href="https://github.com/KedarKK1/MERN-E-COMMERCE/tree/latestBranch/">Link</a></h6></p>
                        </Timeline.Item>
                    </Timeline>
                </Col>
            </Row>
