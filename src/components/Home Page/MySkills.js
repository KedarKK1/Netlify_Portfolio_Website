        ...
        <Fragment style={{ backgroundColor: props.color.myBackgroundColor, }}>
            ...
            <ul className="mySkills" style={{ paddingRight: 30, paddingLeft: 30, backgroundColor: props.color.myBackgroundColor, marginBottom: '0px' }} align={'start'} >
                ...
                <li style={{ marginTop: 15 }}>
                    ...
                    <img src="https://img.shields.io/badge/apachemaven-C71A36.svg?style=for-the-badge&logo=apachemaven&logoColor=white" alt="ApacheMaven_badge" />
                    <img src="https://img.shields.io/badge/Spring%20Boot-6DB33F?style=for-the-badge&logo=springboot&logoColor=fff" alt="Springboot_badge" />
                ...
                <li style={{ marginTop: 15, color: textColor }} align={'start'}>
                    ...
                    <img src="https://img.shields.io/badge/Apache%20Kafka-000?style=for-the-badge&logo=apachekafka" alt="ApacheKafka_badge" />
                    <img src="https://img.shields.io/badge/-ElasticSearch-005571?style=for-the-badge&logo=elasticsearch" alt="ApacheKafka_badge" />
