            ...
            <Row className="myExperience" style={{ width: '100%', paddingTop: '10px', paddingBottom: '10px', justifyContent: 'center', backgroundColor: props.color.myBackgroundColor, color: textColor }}>
                <Col>
                    ...
                    <Timeline mode="alternate">
                        ...
                        <p style={{ color: textColor }}><b><h4 style={{ color: textColor }}>1. IEEE Fest - Credenz Tech Days (CTD) - Frontend(React JS) + Integration<u></u></h4>(Jul 22 - Nov 06)</b></p>
                        ...
                        {/* </Timeline.Item>
                        <Timeline.Item color="red"> */}
                        <p style={{ color: textColor }}><b><h4 style={{ color: textColor }}><u>2. IEEE Fest Credenz`22 - Frontend+Integration</u></h4>(Nov 21 - Mar 22)</b></p>
                        ...
                        <Timeline.Item color="green">
                            ...
                            <p style={{ color: textColor }}><b><h4 style={{ color: textColor }}> <u><a target="_blank" rel="noreferrer" href="https://pict-foss-club.github.io/">Fullstack Developer Intern - Part time <br /> Foss Club, PICT <br /> Created Placement Portal 🔗</a> </u></h4>(Sep 01 - Feb 15, 6 months) <a target="_blank" rel="noreferrer" href="https://drive.google.com/file/d/1qEtcdS9D9niNs9HLaGt0wxxB5ecUXlsb/view?usp=sharing">Internship Certificate</a> & <a target="_blank" rel="noreferrer" href="https://drive.google.com/file/d/1NXaep422yxfN_MtoY0d5Ey52b79V2m5g/view?usp=sharing">Project Expanation Video</a> </b></p>
                        ...
                        <Timeline.Item color="green">
                            <p style={{ color: textColor }}><b><h4 style={{ color: textColor }}>  <u>Frontend Development Intern(Part-Time Remote) <br /> <a target="_blank" rel="noreferrer" href="https://www.intertwinetechnologies.com/">Intertwine Technologies(Previously Offeraya), Pune 🔗</a></u></h4>(10 Apr'23 - 10 July'23, 3 months) <a target="_blank" rel="noreferrer" href="https://drive.google.com/file/d/1nr5MDQHyRgUgOQmq6RicyB1Lvtmdcihd/view?usp=sharing">Internship Certificate 🔗</a>
