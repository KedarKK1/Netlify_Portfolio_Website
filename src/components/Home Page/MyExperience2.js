                ...
                <Col>
                    ...
                    <Timeline mode="alternate">
                        ...
                        <Timeline.Item color="green">
                            ...
                            <p style={{ color: textColor }}><h6 style={{ color: textColor }}><a target="_blank" rel="noreferrer" href="ttps://www.linkedin.com/company/solvevolve/">Deployed on AWS & currently being used by Gurgaon-based IOT startup client....</a></h6></p>
                        </Timeline.Item>
                        <Timeline.Item color="red">
                            <p style={{ color: textColor }}><b><h4 style={{ color: textColor }}>  <u>Frontend Development Internship(Part-Time Remote Intern) - <a target="_blank" rel="noreferrer" href="https://www.intertwinetechnologies.com/">Intertwine Technologies(Previously Offeraya), Pune</a></u></h4>(10 Apr'23 - 11 July'23) <a target="_blank" rel="noreferrer" href="https://drive.google.com/file/d/1nr5MDQHyRgUgOQmq6RicyB1Lvtmdcihd/view?usp=sharing">Internship Certificate</a>
